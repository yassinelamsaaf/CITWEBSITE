  ...
  const cells = [
    {
      ...
      projects: ['E-commerce Platform', 'University Management System', 'Real-time Chat Application'],
      skills: ['Frontend Development', 'Backend Development', 'API Design', 'Database Management'],
      details: 'Our Web Cell is at the forefront of modern web technologies. We specialize in creating responsive, scalable, and user-friendly web applications. Members work on real-world projects using the latest frameworks and tools, gaining hands-on experience in full-stack development.'
    },
    {
      id: 'data',
      title: 'Data Cell',
      ...
      projects: ['Market Analysis Dashboard', 'Predictive Analytics Model', 'Big Data Processing Pipeline'],
      skills: ['Data Analysis', 'Machine Learning', 'Statistical Modeling', 'Data Visualization'],
      details: 'The Data Cell transforms raw information into actionable insights. Our team works with cutting-edge tools and techniques in data science, machine learning, and business intelligence. We tackle real-world problems using statistical analysis and predictive modeling.'
    },
    {
      id: 'devops',
      title: 'DevOps Cell',
      ...
      projects: ['CI/CD Pipeline Automation', 'Cloud Infrastructure Setup', 'Monitoring and Alerting System'],
      skills: ['Infrastructure Automation', 'Cloud Computing', 'Container Orchestration', 'System Monitoring'],
      details: 'Our DevOps Cell focuses on streamlining development workflows and infrastructure management. We work with cloud platforms, automation tools, and monitoring systems to ensure reliable, scalable, and efficient software delivery.'
    },
    {
      id: 'design',
      title: 'Design Cell',
      ...
      projects: ['Mobile App UI/UX Design', 'Brand Identity System', 'Interactive Website Prototype'],
      skills: ['User Interface Design', 'User Experience Research', 'Graphic Design', 'Prototyping'],
      details: 'The Design Cell creates visually stunning and user-centered designs. Our team specializes in UI/UX design, graphic design, and brand development, ensuring that every project is both beautiful and functional.'
    },
    {
      id: 'security',
      title: 'Security Cell',
      ...
      projects: ['Vulnerability Assessment Tool', 'Security Audit Framework', 'Incident Response System'],
      skills: ['Ethical Hacking', 'Security Auditing', 'Risk Assessment', 'Incident Response'],
      details: 'Our Security Cell is dedicated to protecting digital assets and ensuring cybersecurity. We conduct penetration testing, security audits, and develop security frameworks to protect against evolving threats.'
    },
    {
      id: 'algorithmic',
      ...
      projects: ['Algorithm Optimization Library', 'Competitive Programming Platform', 'AI Problem Solver'],
      skills: ['Algorithm Design', 'Data Structures', 'Problem Solving', 'Code Optimization'],
      details: 'The Algorithmic Cell excels in computational problem-solving and algorithm design. We participate in competitive programming contests and develop efficient algorithms for complex computational challenges.'
    }
  ];
              ...
              <div className="cyber-card p-8 h-full group relative overflow-hidden border border-green-400/30 hover:border-green-400 transition-all duration-500">
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex justify-end">
                    ...
                    >
                      <span className="terminal-prompt text-xs">Learn More</span>
                    </button>
                  </div>
                </div>
          ...
          <div className="mt-16 text-center">
            <div className="glass-dark p-8 border border-green-400/30 max-w-4xl mx-auto relative overflow-hidden">
              ...
              <div className="text-green-400 font-mono text-sm">
                <span className="animate-pulse">{'>'}</span> Click "Learn More" to discover detailed information about each cell
              </div>
            </div>
          </div>
        </AnimateOnScroll>
        ...
        {selectedCell && (
          ...
          >
            <AnimateOnScroll animation="scaleIn">
              <div className="glass-dark max-w-6xl w-full min-h-[80vh] border border-green-400/50 relative my-8" onClick={(e) => e.stopPropagation()}>
                {/* Close button */}
                <button 
                  onClick={() => setSelectedCell(null)}
                ...
                {/* Header */}
                <div className={`relative h-32 bg-gradient-to-br ${selectedCell.color} overflow-hidden`}>
                  <div className="absolute inset-0 bg-black/60"></div>
                  <div className="relative z-10 h-full flex items-center justify-center">
                    <h2 className="text-4xl font-bold text-white">{selectedCell.title}</h2>
                  </div>
                </div>
                ...
                <div className="p-8 space-y-8">
                  ...
                  <div>
                    ...
                    <div className="glass-dark p-4 border border-green-400/30">
                      <p className="text-white text-xl font-semibold">{selectedCell.chef}</p>
                      <p className="text-gray-400 text-sm">Leading expert and mentor for the {selectedCell.title}</p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      {selectedCell.members.map((member, index) => (
                        <div key={index} className="glass-dark p-3 border border-green-400/30 text-center">
                          <p className="text-white font-semibold text-sm">{member}</p>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {selectedCell.projects.map((project, index) => (
                        <div key={index} className="glass-dark p-4 border border-green-400/30 border-l-4">
