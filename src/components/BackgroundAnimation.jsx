        ...
        {Array.from({ length: 15 }, (_, i) => (
          <div
            ...
            style={{
              ...
              animation: `float ${5 + Math.random() * 4}s ease-in-out infinite reverse`
            }}
          />
        ))}
        ...
        {Array.from({ length: 8 }, (_, i) => (
          <div
            ...
            className={`absolute w-0.5 h-0.5 rounded-full ${
              ...
              i % 3 === 1 ? 'bg-blue-400/25' : 'bg-purple-400/35'
            }`}
            style={{
              left: `${10 + (i * 12)}%`,
              top: `${20 + Math.sin(i) * 40}%`,
              animation: `float ${5 + i * 0.3}s ease-in-out infinite ${i * 0.5}s`
            }}
          />
        ))}
      </div>
